...
\newthought{Once the system} matrix is assembled, all that remains is to apply boundary conditions and solve by some convenient method.  The resulting coefficient values: $\left\{U_1, U_2, U_3, U_4\right\}$ are the parameters for our approximate solution.  
...
\noindent\ref{lst:ann34n-5} These are the elemental sub-arrays.
