...
\end{equation*}
Next we must combine our indices using $k=n-2$ for the first summation and $k=n+1$ for the second summation respectively.\marginnote[-0.5cm]{\textbf{Reminder:} we take our definition of $k$ from the \underline{exponent for $x$} in each summation term.}  
\begin{equation*}
