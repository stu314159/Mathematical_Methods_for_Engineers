...
\end{enumerate}
for functions $u$,$v$ and scalar constant $\alpha$.  Think of this as a \emph{definition} of linearity.} and we express the solution in the following way: $u(x) = u_c(x) + u_p(x)$. Plugging this into Equation \ref{eq:first-order-linear-standard-form} gives us:
