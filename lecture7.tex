...
Within the radius of convergence, a power series defines a function and the function so defined is:\marginnote{If $x$ is not within the interval of convergence for a series or if the series is divergent then \emph{\textbf{none}} of these are true.  This is why it is important to be able to find the interval/radius of convergence.}
\begin{itemize}
\item continuous 
