...
The factor $x^r$ included in the method of Frobenius means there may not be any constant terms in the series at all.  Therefore there is no reason to omit terms for $u^{\prime}$ or $u^{\prime \prime}$.}
\begin{align*}
