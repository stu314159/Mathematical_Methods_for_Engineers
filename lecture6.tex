...
What we will do, is change the independent variable from $x$ to $e^t$.\sidenote{Think of this as ``streching'' the $x$-axis.}  If $x = e^t$, that means that $t = \ln{x}$ and $\frac{dt}{dx} = \frac{1}{x} = e^{-t}$.
