...
deletekeywords={axis,length,error,colormap, colorbar,ceil,meshgrid,zlabel,surf,realmin, realmax,view,pause,sinh,max,gcf,exp,abs,besselk,sqrt,cosh,movie,cos,sin,clear,clc,close,drawnow,getframe,gcf,figure,fplot,fzero,title,legend,loglog,xlabel,ylabel,set,grid,sprintf,gca,pi,plot,bessely,fprintf,linspace,min,size}
}
