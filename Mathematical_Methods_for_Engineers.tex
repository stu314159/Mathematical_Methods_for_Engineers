...
deletekeywords={axis,length,error,colormap, colorbar,ceil,meshgrid,zlabel,surf,realmin, realmax,view,pause,sinh,max,diag, sparse,spy,eye,gcf,norm,zeros,tic,nnz, toc,disp,rand,exp,type,abs,besselk,sqrt,cosh,movie,cos,lu,sin,clear,clc,close,drawnow,getframe,gcf,figure,fplot,fzero,title,legend,loglog,xlabel,ylabel,set,grid,sprintf,gca,pi,plot,bessely,fprintf,linspace,min,size}
}
