...
deletekeywords={axis,length,error,colormap, colorbar,ceil,meshgrid,zlabel,surf,pause,sinh,cosh,movie,cos,sin,clear,clc,close,drawnow,getframe,gcf,figure,fplot,fzero,title,legend,loglog,xlabel,ylabel,set,grid,sprintf,gca,pi,plot,bessely,fprintf,linspace,min,size}
}
