...
deletekeywords={axis,length,error,colormap,trapz,subplot,semilogy, colorbar,ceil,meshgrid,zlabel,surf,realmin,nan, realmax,view,pause,sinh,max,diag, inv, load, sum, ode23, eps, sparse,spy,eye,polyfit,polyval,interp1,ode45,gcf,norm,zeros,tic,nnz,nan,chol,speye,NaN, toc,disp,rand,exp,type,abs,besselk,sqrt,cosh,movie,cos,lu,sin,clear,clc,close,drawnow,getframe,gcf,figure,fplot,fzero,title,legend,loglog,xlabel,ylabel,set,grid,sprintf,gca,pi,plot,bessely,fprintf,linspace,min,size}
}
...
\input{numerical_methods/lecture26.tex}
\input{numerical_methods/lecture27.tex}

\part{Solving Boundary Value Problems}
\input{numerical_methods/lecture28.tex}
\input{numerical_methods/lecture29.tex}
\input{numerical_methods/assignment9.tex}
\input{numerical_methods/lecture30.tex}
\input{numerical_methods/lecture31.tex}
\input{numerical_methods/lecture32.tex}
\input{numerical_methods/lecture33.tex}
\input{numerical_methods/lecture34.tex}
\input{numerical_methods/lecture35.tex}
