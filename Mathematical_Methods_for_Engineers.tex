...
language=Matlab,
morekeywords={},
deletekeywords={length,cos,sin,clear,clc,close,figure,fplot,fzero,title,legend,xlabel,ylabel,set,grid,sprintf,gca,pi,plot,bessely,fprintf,linspace,min,size}
}
