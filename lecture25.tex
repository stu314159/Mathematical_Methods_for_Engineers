...
\section{Objectives}
\begin{itemize}
\item Describe the details of how to use MATLAB to find solutions to the heat and wave equations.
...
\ref{lst:ann25-1-6} Using the \lstinline[style=myMatlab]{'MarkerIndices'} keyword allows you to specify which data indices get annotated with a marker (when the line specification includes a marker).  The argument \lstinline[style=myMatlab]{1:50:Nx} in this case results in 1 out of every 50 data points having a marker applied.  Experiment with this and see what the plot looks like if you omit this keyword-argument pair.
