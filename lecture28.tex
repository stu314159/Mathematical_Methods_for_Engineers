...
\end{enumerate}
\begin{figure}[h!]
\subfloat[]{\includegraphics[width=2in]{lec28-ex1-sol-alpha-high.png}}
\subfloat[]{\includegraphics[width=2in]{lec28-ex1-sol-alpha-low.png}} \\
\subfloat[]{\includegraphics[width=2in]{lec28-ex1-sol-h-high.png}}
\subfloat[]{\includegraphics[width=2in]{lec28-ex1-sol-h-low.png}}
...
\Rightarrow c_1 &= 0 \\
F_{x}(1) &= \nu c_2 \cosh{\nu} = 0
\end{align*} \marginnote{By this point in time, this analysis may begin to feel quite repetitive.  That is because it is repetitive.  Nonetheless, resist the tendency to rush and/or become complacent.  It is worth your while to patiently and carefully work through each of these cases every time.}
