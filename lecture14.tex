...
\end{equation}
Using this tool requires you to solve four non-linear equations as shown below:\marginnote{Probably the most challenging and error-prone part of this process is writing a given ODE in the form of Equation \ref{eq:bessel-tool}.}
\begin{equation*}
