...
\begin{itemize}
\item the programming languages---e.g. Python, C++, Java and FORTRAN among others---that have been a part of the scientific computing landscape for generations.  
